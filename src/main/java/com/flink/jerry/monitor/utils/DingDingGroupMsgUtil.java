package com.flink.jerry.monitor.utils;

import com.flink.jerry.common.utils.GsonUtil;
import com.flink.jerry.common.utils.HttpUtil;
import com.flink.jerry.monitor.model.AtMobiles;
import com.flink.jerry.monitor.model.LinkMessage;
import com.flink.jerry.monitor.model.MarkDownMessage;
import com.flink.jerry.monitor.model.TextMessage;
...
public class DingDingGroupMsgUtil {
    ...
    public static String sendDingDingMsg(String url, String msg) {
        String result = null;
        try {
            result = HttpUtil.postString(url, msg);
        } catch (Exception e) {
